...
<section class="container-section max-width bg-light">
    <div class="__container__acuerdo__consejo">
        <div class="__card__introduccion">
            <div class="__item__description">
                <h1>Acuerdos de Consejo</h1>
        ...
        <div class="__acuerdo__consejo">
            <div class="__title">
                Acuerdos de Consejo&nbsp;<span class="__anio_select">2023</span>
            </div>
            <table id="tb_acuerdo_consejo" class="table table-hover table-striped mb-0 bg-white w-100">
                <thead>
                    <tr>
