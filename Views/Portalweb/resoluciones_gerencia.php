...
<section class="container-section max-width bg-light">
    <div class="__container__res__gerencia">
        <div class="__card__introduccion">
            <div class="__item__description">
                <h1>Resoluciones de Gerencia</h1>
                <p>Las Resoluciones de Gerencia aprueban y resuelven los asuntos de carácter administrativo de la Municipalidad.
                </p>
            </div>
        ...
        <div class="__card__res__gerencia">
            <div class="__title">
                Resoluciones de Gerencia&nbsp;<span class="__anio_select">2023</span>
            </div>
            <table id="tb_res_gerencia" class="table table-hover table-striped mb-0 bg-white w-100">
                <thead>
                    <tr>
