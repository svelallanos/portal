...
<section class="container-section max-width bg-light">
    <div class="__container__consejo">
        <div class="__card__introduccion">
            <div class="__item__description">
                ...
                <div class="__view__detalle">
                    <a target="_blank" class="btn-bg-danger" href="https://www.gob.mx/cms/uploads/attachment/file/344484/Referencias_Habilidades_Gerenciales.pdf">Ver más</a>
        ...
        <div class="__card__title">
            <h1>Gestión 2023 - 2026</h1>
            <p>Regidores de la Municipalidad Distrital De Elías Soplín Vargas
            </p>
        </div>
        <div class="__card__regidores">
            <div class="__card__filtro">
                ...
                <div class="__button__search">
                    <button class="btn-bg-primary"><i class="feather-search"></i> Buscar</button>
                </div>
            </div>
                ...
                <?php foreach ($data['funcionarios'] as $key => $value) { ?>
                    <div class="__card__user">
                        ...
                        <div class="__descripcion">
                            <h1>Primera Regidora</h1>
                            <span>Ing. <?= $value['funcionario_nombres'] ?>&nbsp;<?= $value['funcionario_paterno'] ?>&nbsp;<?= $value['funcionario_materno'] ?></span>
                        </div>
                        <div class="__social">
                            <div class="__icon">
                            ...
                            <div class="__icon">
                                <a target="_blank" href="<?= $value['funcionario_link_ig'] ?>"><i class="feather-mail"></i></a>
                            </div>
                        </div>
                    </div>
                <?php } ?>
