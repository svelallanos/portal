            ...
            <div class="page-header-content">
                <div class="row align-items-center justify-content-between pt-3">
                    ...
                    <div class="col-12 col-xl-auto mb-3">
                        ...
                        <button class="btn btn-sm btn-light text-primary" data-bs-toggle="modal" data-bs-target="#modal_gestion">
    ...
    <div class="container-xxl px-4 mt-5">
        <div class="card p-3">
            <div class="table-responsive">
                <table id="tb_gestion" class="table-bordered dataTable table-striped table-hover table-sm w-100">
                    <thead>
                        <tr>
                            <th>ACCIONES</th>
                            <th>NOMBRES</th>
...
getModal('modal_gestion_alcaldia', $data);
?>