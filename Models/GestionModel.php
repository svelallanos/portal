...
class GestionModel extends Mysql
{
    ...
    {
        $sql = "INSERT INTO gestion (usuarios_id, gestion_nombre, gestion_descripcion, gestion_fecha_inicio, gestion_fecha_final) VALUES (:usuarios_id, :gestion_nombre, :gestion_descripcion, :gestion_fecha_inicio, :gestion_fecha_final)";
    ...
    {
        $sql = 'UPDATE gestion SET gestion_nombre = :gestion_nombre,gestion_descripcion = :gestion_descripcion, gestion_fecha_inicio = :gestion_fecha_inicio, gestion_fecha_final = :gestion_fecha_final 
